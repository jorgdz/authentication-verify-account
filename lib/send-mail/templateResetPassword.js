                                  ...
                                  <tr style="border-collapse:collapse">
                                    <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                      <p
                                        ...
                                        <b>Por favor ingresa al siguiente enlace</b> <a href="${process.env.APP_URL}/password/reset/${user.id}/${user.password_reset_code}">${process.env.APP_URL}/password/reset/${user.id}/${user.password_reset_code}</a> <b> para cambiar tu contraseña.</b>
                                    </p>
                                    </td>
                                  </tr>
                                </table>

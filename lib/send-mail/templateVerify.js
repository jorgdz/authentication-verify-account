                                  ...
                                  <tr style="border-collapse:collapse">
                                    <td align="center" style="padding:0;Margin:0;padding-bottom:10px">
                                      <h1
                                        ...
                                        ¡Bienvenido a este Test, verifica tu correo!</h1>
                                    </td>
                                  </tr>
                                  <tr style="border-collapse:collapse">
                                    <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                      <p
                                        ...
                                        <b>Por favor ingresa a </b><a href="${process.env.APP_URL}/confirm/verify/${userRegister.id}/${userRegister.verification_code}">${process.env.APP_URL}/confirm/verify/${userRegister.id}/${userRegister.verification_code}</a>
                                    </p>
                                    </td>
                                  </tr>
                                </table>
